...
//   'Enjoy!',
//   [
//     {text: 'T20 = Total D20 Roll, Charge/FlankCanny Tumble + Haste + Song', onPress: () => console.log('D20 Roll Total')},
...
//   }
  ...
  handleButtonPress=()=> {
    ...
    let D8S3 = diceroll8S3a + diceroll8S3b +
      diceroll8S3c + diceroll8S3d + diceroll8S1d;
  ...
  render() {
    ...
    return (
      <ImageBackground source={require('../images/Laylo5.jpg')} style={styles.container}>
